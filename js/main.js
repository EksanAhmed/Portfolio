        ...
        if(event.target.classList.contains('link-item')){
            ...
            if(event.target.hash !=="") {
                ...
                if(navMenu.classList.contains("open")) {
                    ...
                    hideNavMenu();
                    // console.log("clicked 'link-item  is conatined within the navigation menu'")
                }
                else {
                    // console.log("clicked 'link-item  is not conatined within the navigation menu'")
...
(() => {
    ...
    filterContainer.addEventListener("click", (event) => {
        ...
        !event.target.classList.contains("active")) {
            ...
            portfolioItems.forEach((item) => {
                // console.log(item);
                // console.log(item.getAttribute("data-catagory"));
    ...
    function popupDetails() {
        // if portfolio-item-details doesnot exist
